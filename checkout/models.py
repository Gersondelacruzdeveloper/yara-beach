...
class ExcursionOrder(models.Model):
    ...
    child_qty =  models.IntegerField(null=True, blank=True)
    ...
    flight_number = models.CharField(max_length=200, null=True, blank=True, default='')
    room_number = models.CharField(max_length=200, null=True, blank=True, default='')
