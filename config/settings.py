...
SELLER_PLUS_COMPANY_AMOUNT = env.str("SELLER_PLUS_COMPANY_AMOUNT")
PAYPAL_PERCENTAGE_FEES = env.str("PAYPAL_PERCENTAGE_FEES")
PAYPAL_FIXED_FEES = env.str("PAYPAL_FIXED_FEES")

DISCOUNT_PERCENTAGE = env.str("DISCOUNT_PERCENTAGE")
